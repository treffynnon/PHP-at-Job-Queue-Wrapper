...
class Wrapper {
    ...
    public function queue(Job $job, $queue = null)
    {
    ...
    */
    static public function removeJob($job_number) {
        ...
        if(count($output)) {
            throw new E\JobNotFound("The job number $job_number could not be found");
        }
    }
    ...
    static protected function addJob($job_exec_string) {
        ...
        if(!count($job)) {
            throw new E\JobAdd('The job has not been sucessfully
